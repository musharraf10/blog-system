...
//                     className={`flex items-center px-4 py-2.5 rounded-lg transition-all duration-300 whitespace-nowrap ${location.pathname === "/subscriber/settings"
//                         ? "bg-gradient-to-r from-[#1565C0]/10 to-[#42A5F5]/20 text-[#1565C0] font-medium border-l-4 border-[#1565C0] shadow-sm"
//                         : "text-gray-700 hover:bg-white/90 hover:shadow-sm"
//                       }`}
//                   >
//                     <Cog6ToothIcon
//                       className={`h-5 w-5 mr-3 flex-shrink-0 ${location.pathname === "/subscriber/settings" ? "text-[#1565C0]" : "text-gray-500"
//                         }`}
//                     />
...
import { FaBlog, FaUserEdit, FaCalendarPlus, FaTags, FaUsersCog } from "react-icons/fa";
import { MdContentPaste, MdFavorite } from "react-icons/md"; // Icons for Trending and Liked Content
import { Link, Outlet, useLocation } from "react-router-dom";
import PrivateNavbar from "../Navbar/PrivateNavbar";
...
const navigation = [
  ...
  { name: "Bookmarks", href: "/subscriber/bookmarks", icon: FaCalendarPlus },
  { name: "Upcoming Events", href: "/subscriber/upcomingevents", icon: FaTags },
  { name: "Trending Content", href: "/subscriber/trendingcontent", icon: MdContentPaste }, // Added Trending Content
  { name: "Liked Content", href: "/subscriber/likedcontent", icon: MdFavorite }, // Added Liked Content
];
