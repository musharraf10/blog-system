...
const Register = () => {
  ...
  return (
    ...
    //     <h1 style={{fontWeight:700}}>Registration Form</h1>
    //     <br/>
    //     <form onSubmit={formik.handleSubmit}>
    ...
    //       <input className="register-input" type="text" {...formik.getFieldProps("username")} />
    //       {formik.touched.username && formik.errors.username && (
    //         <div className="error-message">{formik.errors.username}</div>
    //       )}

    //       <label className="register-label">Email</label>
    //       <input className="register-input" type="text" {...formik.getFieldProps("email")} />
    //       {formik.touched.email && formik.errors.email && (
    //         <div className="error-message">{formik.errors.email}</div>
    //       )}

    //       <label className="register-label">Password</label>
    //       <input className="register-input" type="password" {...formik.getFieldProps("password")} />
    //       {formik.touched.password && formik.errors.password && (
