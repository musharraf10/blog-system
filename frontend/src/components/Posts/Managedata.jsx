...
=======
>>>>>>> 5002ea7bcbdd6171efa45ad9ceaafe48a628806b
  {/* Header */ }
      ...
      <div className="px-8 py-6 bg-gray-50 border-b border-gray-200 flex flex-wrap items-center">
        <button
          onClick={() => setActiveFilter("all")
              className={`mr-3 mb-2 px-5 py-2.5 rounded-lg transition-all duration-300 font-medium ${activeFilter === "all"
        ...
        {contentTypes.map((type) => {
          ...
          return (
            <button
              ...
              className={`mr-3 mb-2 px-5 py-2.5 rounded-lg transition-all duration-300 font-medium ${activeFilter === type.type
                ? "bg-gradient-to-r from-[#1565C0] to-[#42A5F5] text-white shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                : "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 hover:border-gray-400"
              ...
              <tr key={item.id} className="hover:bg-blue-50 transition-all duration-300">
                ...
                <td className="px-6 py-6 text-center">
                  <span
                    ...
                    className={`px-3 py-1.5 text-xs font-semibold rounded-full inline-block transition-all duration-300 ${getTypeInfo(item.type).badge} hover:shadow-sm`}
